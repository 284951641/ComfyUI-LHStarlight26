...
MODEL_REGISTRY = {
    ...
    "starlight26_vae_softness3_bf16.safetensors": ModelInfo(category="vae", precision="bf16", variant="softness3"),
    # 3B models
...
DEFAULT_DIT = "starlight26_dit_3b_bf16.safetensors"
DEFAULT_VAE = "starlight26_vae_bf16.safetensors"
