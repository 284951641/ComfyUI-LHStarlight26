...
class Starlight26VideoUpscaler(io.ComfyNode):
    """
    ...
    def define_schema(cls) -> io.Schema:        
        return io.Schema(
            node_id="Starlight26VideoUpscaler",
            display_name=f"星光2.6｜视频超分（v{__version__}）",
            category="星光2.6/RunningHub",
            description=(
    ...
    def execute(cls, image: torch.Tensor, dit: Dict[str, Any], vae: Dict[str, Any], 
                seed: int, resolution: int = 1080, max_resolution: int = 3840, batch_size: int = 121,
                uniform_batch_size: bool = True, temporal_overlap: int = 21, prepend_frames: int = 0,
