...
class Starlight26LoadVAEModel(io.ComfyNode):
    """
    ...
    def define_schema(cls) -> io.Schema:        
        ...
        return io.Schema(
            node_id="Starlight26LoadVAEModel",
            display_name="星光2.6｜加载专用 VAE（柔和度）",
    ...
    def execute(cls, model: str, device: str, offload_device: str = "none",
                     ...
                     encode_tile_size: int = 640, encode_tile_overlap: int = 80,
                     decode_tiled: bool = True, decode_tile_size: int = 480,
                     decode_tile_overlap: int = 60, tile_debug: str = "false",
